...
public class EditerActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentContactUri == null) {
            mPhoto.setImageResource(R.drawable.ic_baseline_insert_photo_24);
            ...
            getLoaderManager().initLoader(LOADER,
                    null,
                    this);
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                if (!mContactHasChanged) {
                    ...
                    NavUtils.navigateUpFromSameTask(EditerActivity.this);
                    return true;
